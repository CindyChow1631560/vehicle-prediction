# -*- coding: utf-8 -*-
"""
Created on Tue Jan 23 19:30:29 2018
...
That's why , instead of removing them all, we will just manage to make some of our models robust on them. You can refer to the modelling part of this notebook for that.
'''
sns.distplot(train['SalePrice'] , fit=norm);##distplot( )为hist加强版，kdeplot( )为密度曲线图

# Get the fitted parameters used by the function
(mu, sigma) = norm.fit(train['SalePrice'])#拟合正态分布
print( '\n mu = {:.2f} and sigma = {:.2f}\n'.format(mu, sigma))
...
#BsmtFinSF1, BsmtFinSF2, BsmtUnfSF, TotalBsmtSF, BsmtFullBath and BsmtHalfBath : missing values 
#are likely zero for having no basement
...
#Exterior1st and Exterior2nd : Again Both Exterior 1 & 2 have only one missing value. We will
# just substitute in the most common string
